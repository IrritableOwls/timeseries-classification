...
namespace SampleClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"G:\Desktop\NEURAL NETS\recent_data_BCE\1m_BTCUSDT_CROSSENTROPY.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options() { NumberOfLeaves = 48, MinimumExampleCountPerLeaf = 50, NumberOfTrees = 100, LearningRate = 0.09011454f, Shrinkage = 0.7266149f, LabelColumnName = "col10", FeatureColumnName = "Features" }), labelColumnName: "col10")
